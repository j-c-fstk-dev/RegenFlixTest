...
const supabaseKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.SUPABASE_KEY;
...
function LoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (isLogin) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            setIsLoading(false);
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email,
                password
            });
            setIsLoading(false);
...
_s(LoginForm, "QuMuaeI4/UUhrBnFiF/3uI57s74=", false, function() {
    return [
...
//# sourceMappingURL=src_96bfd7b6._.js.map